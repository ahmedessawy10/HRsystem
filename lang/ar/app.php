...
return [
    ...
    */
    ...
    'password.length' => 'أن تكون مكونة من 12 حرفًا على الأقل',
    'password.uppercase' => 'أن تحتوي على حرف كبير واحد على الأقل',
    'password.lowercase' => 'أن تحتوي على حرف صغير واحد على الأقل',
    'password.number' => 'أن تحتوي على رقم واحد على الأقل',
    'password.special' => 'أن تحتوي على رمز خاص واحد على الأقل',
    'password.validation' => 'ملاحظة! يجب أن تحتوي كلمة المرور على:',
    'search.or.start.chat' => 'ابحث أو ابدأ محادثة',
    ...
    'updated at' => 'تاريخ التحديث',
    'users' => 'المستخدمون',
    'ai rate' => 'تقييم الذكاء الاصطناعي',
    'ai summary' => 'ملخص الذكاء الاصطناعي',
    'cover letter' => 'خطاب التغطية',
    'cv' => 'السيرة الذاتية',
    'phone' => 'رقم الهاتف',
    'career id' => 'رقم الوظيفة',
    'career name' => 'اسم الوظيفة',
    'career applications' => 'طلبات التوظيف',
    ...
    'application name' => 'اسم المتقدم',
    'application email' => 'بريد المتقدم',
    'application phone' => 'هاتف المتقدم',
    'application cv' => 'سيرة المتقدم الذاتية',
    'application cover letter' => 'خطاب التغطية للمتقدم',
    'application ai rate' => 'تقييم الذكاء الاصطناعي للمتقدم',
