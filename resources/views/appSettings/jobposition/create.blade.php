                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <i class="fas fa-calendar-plus mr-2"></i> {{ __("app.create jobposition") }}
                                </h4>
                            </div>
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <form action="{{ route('jobpositions.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select type="text" class="form-control" id="department" name="department_id"
                                            ...
                                            <option value="{{$dep->id}}"
                                                {{old('department_id')==$dep->id ?"selected":"" }}>{{$dep->name}}
                                            </option>
                                            @endforeach
                                    ...
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-check mr-2"></i> {{ __("Create Department") }}
                                    </button>
                                </form>
                            </div>
                        </div>
