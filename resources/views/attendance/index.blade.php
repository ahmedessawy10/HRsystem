...
<div class="container py-4">
    <div class="card shadow border-0">
        ...
        <div class="card-header">
            <h4><i class="bi bi-calendar-check me-2"></i> Attendance Management</h4>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-2 d-flex align-items-end">
                    <button class="btn btn-filter w-100" id="filter-btn"><i class="bi bi-funnel me-2"></i> Filter</button>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach($attendances as $attendance)
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-late">{{ $attendance->late_minutes }}</span>
                                </td>
                                <td>
                                    <span class="badge badge-extra">{{ $attendance->extra_minutes }}</span>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('attendance.edit', $attendance->id) }}" class="btn btn-edit btn-action">
