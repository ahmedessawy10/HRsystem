                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($cv->summary)
                                            <div class="text-wrap"
                                                style="max-width: 200px; max-height: 80px; overflow-y: auto;">
                                                {{ Str::limit($cv->summary, 100) }}
                                                @if(strlen($cv->summary) > 100)
                                                <a href="#" class="view-summary" data-bs-toggle="modal"
                                                    data-bs-target="#summaryModal" data-summary="{{ $cv->summary }}">
                                                    {{ __('Read More') }}
                                                </a>
                                                @endif
                                            </div>
                                        ...
                                        <td>
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar"
                                                    ...
                                                    aria-valuenow="{{ $cv->skill_score }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    {{ $cv->skill_score }}%
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="progress">
                                                <div class="progress-bar bg-info" role="progressbar"
                                                    ...
                                                    aria-valuenow="{{ $cv->soft_skills }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    {{ $cv->soft_skills }}%
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="progress">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    ...
                                                    aria-valuenow="{{ $cv->education_score }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    {{ $cv->education_score }}%
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="progress">
                                                <div class="progress-bar bg-warning" role="progressbar"
                                                    ...
                                                    aria-valuenow="{{ $cv->relevant_experience }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                        ...
                                        <td>
                                            <div class="progress">
                                                <div class="progress-bar bg-primary" role="progressbar"
                                                    ...
                                                    aria-valuenow="{{ $cv->fit_score }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    {{ $cv->fit_score }}%
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $cv->status === 'completed' ? 'success' : ($cv->status === 'processing' ? 'warning' : 'danger') }}">
                                                {{ ucfirst($cv->status) }}
                                            </span>
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ Storage::url($cv->file_path) }}" class="btn btn-sm btn-info"
                                                    target="_blank" title="{{ __('View CV') }}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </div>
                                        </td>
